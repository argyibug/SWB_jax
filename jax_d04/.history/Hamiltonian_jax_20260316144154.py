...
def Ham_jax(omega: float, k1: jnp.ndarray, k2: jnp.ndarray,
    ...
    for b in range(bond_n):
        ...
        H = H+H.at[:, s1_dwo_idx, s2_dwd_idx].set(Jplus[b] * A[b] * jnp.sin(kr))
        H = H+H.at[:, s2_upo_idx, s1_upd_idx].set(Jplus[b] * A[b] * jnp.sin(kr))
        H = H.at[:, s2_dwo_idx, s1_dwd_idx].set(Jplus[b] * A[b] * jnp.sin(kr))
