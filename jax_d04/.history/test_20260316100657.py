...
# 读取晶格信息
[bond_tab, n_bond, n_spin] = IO.create_bond_table_file(unit_vector_filepath='unit_vector.in', cellspin_filepath='cellspin.in')
[bond_tab, n_bond] = IO.read_bond_table(filepath='bond.log')
