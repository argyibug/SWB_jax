...
class SaddlePointOptimizer:
    ...
    def saddle_point_eq_number(self, lambda_param: float, A1: complex, B1: complex) -> float:
        ...
        Ubov = Bogoliubov_transform_2_jax(
            ...
            self.J1plus, self.J2plus, self.J3plus, self.bond_tab, self.bond_n, self.spin_n)[0]
        # print("--------------------------------------------------")
            
        lam = saddle_point_sum_jax(Ubov, self.k1, self.k2)[0]
        z = (lam - 2.0 * self.S)**2
    ...
    def saddle_point_constraint(self, lambda_param: float, A1: complex, B1: complex) -> List[float]:
        ...
        con_eig = Bogoliubov_constraint_jax(0, self.k1, self.k2, A1, A2, A3, B1, B2, B3, 
                                        lambda_param, self.h, self.J1plus, self.J2plus, self.J3plus, self.bond_tab, self.bond_n, self.spin_n)
    ...
    def saddle_point_eq_auxiliary_fields(self, x: np.ndarray) -> float:
        ...
        Ubov = Bogoliubov_transform_2_jax(
             0, self.k1, self.k2, A1, A2, A3, B1, B2, B3, lambda_param, self.h,
             self.J1plus, self.J2plus, self.J3plus, self.bond_tab, self.n_bond)[0]
