...
def Ham_jax(omega: float, k1: jnp.ndarray, k2: jnp.ndarray,
    ...
    H = H.at[:, idx_upd, (mat_dim -1 - idx_upd)].set(diag_up)
    H = H.at[:, idx_dwd, (mat_dim -1 - idx_dwd)].set(diag_dw)
    H = H.at[:, idx_upo, (mat_dim -1 - idx_upo)].set(diag_up)
    H = H.at[:, idx_dwo, (mat_dim -1 - idx_dwo)].set(diag_dw)
