...
def Ham_jax(omega: float, k1: jnp.ndarray, k2: jnp.ndarray, 
    ...
    jax.debug.print("k1= {k1}, k2= {k2}, Q1= {Q1}, Q2= {Q2}, A1= {A1}, A2= {A2}, A3= {A3}, B1= {B1}, B2= {B2}, B3= {B3}, lambda_param= {lambda_param}, h= {h}",
                   k1=k1[0], k2=k2[0], Q1=Q1, Q2=Q2, A1=A1, A2=A2, A3=A3, B1=B1, B2=B2, B3=B3, lambda_param=lambda_param, h=h,ordered=True)
    jax.debug.print("+++++++++++++++++++++++++=====================+++++++++++++++++++++++++=====================",ordered=True)
    # k1_plus = Q1/2
    # k2_plus = Q2/2
    # k1_minus = Q1/2
    # k2_minus = Q2/2
    # jax.debug.print("k1_plus: {k1_plus}, k2_plus: {k2_plus}, k1_minus: {k1_minus}, k2_minus: {k2_minus}",
    #                k1_plus=k1_plus, k2_plus=k2_plus, k1_minus=k1_minus, k2_minus=k2_minus)
    ...
    # jax.debug.print("gamma_B_plus: {gamma_B_plus}, gamma_B_minus: {gamma_B_minus}",gamma_B_plus=gamma_B_plus, gamma_B_minus=gamma_B_minus)
